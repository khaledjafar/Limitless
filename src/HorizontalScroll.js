      ...
      <div className="gallery-wrapper">
        <div className="gallery" ref={galleryRef}>
          ...
          <div className='gallery-content'>
            ...
            <a className='project-link-text' href='https://portfolio-khaledjafars-projects.vercel.app'>My Portfolio</a>
          ...
          <div className='gallery-content'>
            ...
            <a className='project-link-text' href='https://advs.test.jo/'>Advs.jo</a>
          ...
          <div className='gallery-content'>
            ...
            <a className='project-link-text' href='https://youtu.be/fGzMhksNn6g'>NearMe</a>
